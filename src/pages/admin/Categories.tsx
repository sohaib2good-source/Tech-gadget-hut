                    ...
                    <tr key={c.id} className="hover:bg-cyan-800/30 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-2">
                          <button onClick={() => { setEditingId(c.id); setFormData({ name: c.name, slug: c.slug }); }} className="p-2 text-cyan-400 hover:bg-cyan-700 rounded-lg">
                            <Edit className="w-4 h-4" />
                          </button>
                          <button onClick={() => handleDelete(c.id, c.name)} className="p-2 text-red-400 hover:bg-red-500/10 rounded-lg">
